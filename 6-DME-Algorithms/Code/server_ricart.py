            ...
            try:
                ...
                if command == "REQUEST":
                    if self.allocated == "":
                        ...
                        print("Timestamp of {} is {}".format(
                            client_name, datetime.fromtimestamp(int(data[data.find("~")+1:]))))
                        print("Timestamp of {} is {}".format(
                            self.allocated, datetime.fromtimestamp(self.timestamp)))
                        print("Resource cannot be allocated to {}".format(
                            client_name))
